...
:compile
ECHO Compiling...
gcc src/*.c -o %CompiledFile% -O1 -Wall -Wextra -Wno-unused-parameter -pedantic-errors -std=c17 -Wno-missing-braces -I src/include/ -L lib/win64_mingw-w64/ -lraylib -lbox2d -lopengl32 -lgdi32 -lwinmm
GOTO nextStep
